...
const V=(()=>{try{return new URL(document.currentScript?.src||'',location.href).searchParams.get('v')||'23.6.121'}catch(_){return'23.6.121'}})().replace(/^v/,''),flights=new Map(),contractFlights=new Map();
